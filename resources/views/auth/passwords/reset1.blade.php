...
<div class="login-box">
  <div class="login-logo">
    <a href="{{ admin_url('/') }}"><b>{{config('register.resetPassword')}}</b></a>
  </div>
  <!-- /.login-logo -->
      ...
      <div class="row">
        <div class="col-xs-8">
          @if(config('admin.auth.remember'))
            <div >
              <label ><a href="login">已有账号？{{ config('') }}</a>></label>
              {{--<label>--}}
        ...
        <div class="col-xs-4">
          ...
          <button type="submit" class="btn btn-primary btn-block btn-flat">{{ config('register.chongzhi') }}</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
